...
type UserServiceClient interface {
	...
	FindUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetailResponse, error)
}
...
func (c *userServiceClient) FindUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	out := new(UserDetailResponse)
...
type UserServiceServer interface {
	...
	FindUser(context.Context, *UserRequest) (*UserDetailResponse, error)
...
func (UnimplementedUserServiceServer) FindUser(context.Context, *UserRequest) (*UserDetailResponse, error) {
